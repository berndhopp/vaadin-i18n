 ...
 * It may be attached to a {@link Component} that needs its {@link Component#getCaption()}
 * translated for different {@link java.util.Locale}s. Translations are is evaluated by the the configured
 * {@link Translator#translate(String)} which gets passed the {@link Value#value()}.
 *
